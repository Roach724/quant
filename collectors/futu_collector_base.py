...
class FutuCollector:
    ...
    def call_api(self, method_name: str, *args, **kwargs):
        """Call a Futu quote API with rate limiting and retry."""
        self._rate_limit()
        ctx = self._get_ctx()
    ...
    def collect_one(self, symbol: str) -> Optional[pd.DataFrame]:
    ...
    def save_to_gcs(self, df: pd.DataFrame, table_name: str, date_str: str = None):
