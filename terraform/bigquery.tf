...
# =============================================================================
# ⛔ DEPRECATED as of 2026-05-29 — BQ Loader Cloud Run Jobs
# BigQuery loading now handled by local VM cron (see terraform/startup.sh).
# These Cloud Run + Scheduler resources are kept as reference only.
# =============================================================================
